...
class UNetNNTrainerFish(NNTrainer):
    def __init__(self, **kwargs):
        NNTrainer.__init__(self, **kwargs)
    ...
    def train(self, optimizer=None, data_loader=None, epochs=None, log_frequency=200,
        ...
        for epoch in range(0, epochs):
            ...
            for i, data in enumerate(data_loader, 0):
                ...
                w_0 = random.randint(0, 100) / 100
                w_1 = random.uniform(0, 100) / 100
                loss = F.nll_loss(outputs, labels, torch.Tensor([w_0, w_1]).to(self.device))
                loss.backward()
                optimizer.step()
...
class UNetNNTrainerWeighted(NNTrainer):
    def __init__(self, **kwargs):
        NNTrainer.__init__(self, **kwargs)
